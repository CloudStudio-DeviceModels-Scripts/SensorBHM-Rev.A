...
# Configuration Script – Sensor BHM - Rev. A

This **Configuration** script is designed for the **Sensor BHM** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Sensor BHM Rev. A

Este script de **Configuration** está diseñado para el modelo **Sensor BHM** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
