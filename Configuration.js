...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var e1 = endpoints.addEndpoint("1", "Sensor de Respiración", endpointType.genericSensor);
  e1.variableTypeId = 1360;
  var e2 = endpoints.addEndpoint("2", "Frecuencia Cardíaca", endpointType.genericSensor);
  e2.variableTypeId = 1359;
  var e3 = endpoints.addEndpoint("3", "Distancia", endpointType.genericSensor);
  e3.variableTypeId = 1362;
  var e4 = endpoints.addEndpoint("4", "Grado de Movimiento", endpointType.genericSensor);
  e4.variableTypeId = 1363;
}
